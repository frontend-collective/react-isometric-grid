...
AnimOnScroll.prototype = {
  ...
  _init: function() {
    ...
    this.items.forEach(function(el, i) {
      if (inViewport(el)) {
        ...
        bonzo(el).addClass(styles.shown);
      }
    });
  ...
  _scrollPage: function() {
    ...
    this.items.forEach(function(el, i) {
      if (
        !bonzo(el).hasClass(styles.shown) &&
        !bonzo(el).hasClass(styles.animate) &&
        ...
        setTimeout(function() {
          ...
          bonzo(el).addClass(styles.animate);
          onEndAnimation(el, function() {
            bonzo(el).addClass(styles.shown);
            bonzo(el).removeClass(styles.animate);
          });
        }, 25);
      }
    });
